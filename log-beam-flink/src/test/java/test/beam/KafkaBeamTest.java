...
public class KafkaBeamTest {
	...
	public static final String group = "beam-test";
	...
	public static void main(String[] args) {
		...
		PCollection<String> events = pipeline
				.apply(
						...
						KafkaIO.<String, String>read()
								// 必需，设置kafka的服务器地址和端口
								.withBootstrapServers(KafkaUtils.borkers).withTopic(KafkaUtils.topic)// 必需，设置要读取的kafka的topic名称
		...
		counts.apply(MapElements.via(new SimpleFunction<KV<String, Long>, String>() {
			...
			public String apply(KV<String, Long> input) {
				...
				// write to kafka
				.apply(KafkaIO.<Void, String>write().withBootstrapServers(KafkaUtils.borkers)
						.withTopic(KafkaUtils.topic_result)
